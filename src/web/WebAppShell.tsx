...
import { webNavigationItems } from '../navigation/navigationItems'

export function WebAppShell({ children }: PropsWithChildren): React.JSX.Element {
      ...
      <header className="site-header">
        <div className="site-header__inner">
          ...
          <nav className="desktop-nav" aria-label="主导航">
            {webNavigationItems.map(({ to, label }) => (
        ...
        {menuOpen && (
          <nav id="mobile-navigation" className="mobile-nav" aria-label="移动端导航">
            {webNavigationItems.map(({ to, label, icon: Icon }) => (
